...
import cuisins1 from "../uploads/cuisins1.jpg";
import cuisins2 from "../uploads/cuisins2.jpg";
import card1 from "../uploads/card1.jpg";
import card2 from "../uploads/card2.jpg";
import card3 from "../uploads/card3.jpg";
import card4 from "../uploads/card4.jpg";
import card5 from "../uploads/card5.jpg";
import card6 from "../uploads/card6.jpg";
import card7 from "../uploads/card7.jpg";
import card8 from "../uploads/card8.jpg";
const Cuisin = () => {
  return (
    <div>
      <div className="container">
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-12 col-md-6">
              ...
              <p>
                ...
                cumin and tangy Greek yogurt. <br />
              </p>
            </div>
            <div className="col-12 col-md-6 p-5">
              <figure className="py-4">
                <img
                  src={cuisins1}
                  alt=""
                  className="img-fluid cuisins_shadow"
                />
              </figure>
              <figure className="py-4">
                <img
          ...
          <div className="row">
            <div className="col-12 col-md-6">
              <div class="card my-3">
                <img src={card1} class="card-img-top cuisins_shadow" alt="..." />
                <div class="card-body text-center card_bg p-4">
                  <h3>Olive Oil For Aroma And Body</h3>
                  <p class="card-text">
                    Olive oil is more than just a cooking medium in the Kokkari
                    kitchen. Its the foundation on which almost every savory
                    dish rests. Used liberally, olive oil adds a silky body and
                    lush richness to braised dishes and greens.{" "}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-md-6">
              <div class="card my-3">
                <img src={card2} class="card-img-top cuisins_shadow" alt="..." />
                <div class="card-body text-center card_bg p-4">
                  <h3>Olive Oil For Aroma And Body</h3>
                  <p class="card-text">
                    Olive oil is more than just a cooking medium in the Kokkari
            ...
            <div className="col-12 col-md-6">
              <div class="card my-3">
                <img src={card3} class="card-img-top cuisins_shadow" alt="..." />
                <div class="card-body text-center card_bg p-4">
                  <h3>Olive Oil For Aroma And Body</h3>
                  <p class="card-text">
                    Olive oil is more than just a cooking medium in the Kokkari
            ...
            <div className="col-12 col-md-6">
              <div class="card my-3">
                <img src={card4} class="card-img-top cuisins_shadow" alt="..." />
                <div class="card-body text-center card_bg p-4">
                  <h3>Olive Oil For Aroma And Body</h3>
                  <p class="card-text">
                    Olive oil is more than just a cooking medium in the Kokkari
            ...
            <div className="col-12 col-md-6">
              <div class="card my-3">
                <img src={card5} class="card-img-top cuisins_shadow" alt="..." />
                <div class="card-body text-center card_bg p-4">
                  <h3>Olive Oil For Aroma And Body</h3>
                  <p class="card-text">
                    Olive oil is more than just a cooking medium in the Kokkari
            ...
            <div className="col-12 col-md-6">
              <div class="card my-3">
                <img src={card6} class="card-img-top cuisins_shadow" alt="..." />
                <div class="card-body text-center card_bg p-4">
                  <h3>Olive Oil For Aroma And Body</h3>
                  <p class="card-text">
                    Olive oil is more than just a cooking medium in the Kokkari
            ...
            <div className="col-12 col-md-6">
              <div class="card my-3">
                <img src={card7} class="card-img-top cuisins_shadow" alt="..." />
                <div class="card-body text-center card_bg p-4">
                  <h3>Olive Oil For Aroma And Body</h3>
                  <p class="card-text">
                    Olive oil is more than just a cooking medium in the Kokkari
            ...
            <div className="col-12 col-md-6">
              <div class="card my-3">
                <img src={card8} class="card-img-top cuisins_shadow" alt="..." />
                <div class="card-body text-center card_bg p-4">
                  <h3>Olive Oil For Aroma And Body</h3>
                  <p class="card-text">
                    Olive oil is more than just a cooking medium in the Kokkari
