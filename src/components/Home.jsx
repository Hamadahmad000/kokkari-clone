   ...
   <div className="bd-color">
    ...
    <div className="container-fluid">
        <div className="row">
          ...
          <div className="desc">
            <h5 className='text-uppercase pt-3 mb-5'>please call <span className='home_desc_col'> 415.981.0983 </span> for reservations <br />
or online through <span className='home_desc_col'>opentable </span></h5>
          </div>
          </div>
        </div>
    </div>
...
<span className='home_desc_col'>HEALTH AND SAFETY PROTOCOLS</span> <br />
